...
namespace sc_m_c
{
	...
	public:
		...
		*/
		int poll(sensor_msgs::msg::LaserScan::SharedPtr scan,int fd);
		void PointCloudFilter(sensor_msgs::msg::LaserScan::SharedPtr Scan);
		void angle_insert(sensor_msgs::msg::LaserScan::SharedPtr scan_in, sensor_msgs::msg::LaserScan::SharedPtr scan_out);
